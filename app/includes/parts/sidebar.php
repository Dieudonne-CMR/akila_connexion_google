...
<?php if (@$active == 2) : ?>
    <div>
        <div class="logo-wrapper"><a href="home"><img class="img-fluid" src="assets/images/logo/logo_light.png" alt=""></a>
        ...
        <div class="logo-icon-wrapper"><a href="home"><img class="img-fluid" src="assets/images/logo/logo-icon.png" alt=""></a></div>
        <nav class="sidebar-main">
            <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    <li class="back-btn"><a href="home"><img class="img-fluid" src="assets/images/logo/logo-icon.png" alt=""></a>
                    ...
                    <li class="sidebar-list"><a class="sidebar-link" href="home">
                            <svg class="stroke-icon">
                                <use href="assets/svg/icon-sprite.svg#stroke-home"></use>
                            </svg>
                            <span class="">Accueil </span></a>
                ...
                <?php if(@$dispo_artcle==1): ?>
                    <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                            ...
                            </svg><span class="">Articles </span></a>
                        <ul class="sidebar-submenu">
                            <li><a href="posts">Voir les articles</a></li>
                            <li><a href="@add-post">Ajouter un article</a></li>
                        </ul>
                    </li>  
                <?php endif; ?>
                    ...
                    <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                            ...
                            <svg class="fill-icon">
                                <use href="assets/svg/icon-sprite.svg#fill-widget"></use>
                            </svg><span class="">Annonces</span></a>
                        <ul class="sidebar-submenu">
                            <li><a href="annonces">Voir les annonces</a></li>
                            <!-- <li><a href="@add-post">Ajouter un article</a></li> -->
                        </ul>
                    </li>
                    <!-- annonces -->
                    ...
                    <?php if (isset($permalien) and @$onsite != 0 and @$id_core != 5) : ?>
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                                <svg class="stroke-icon">
                                ...
                                <svg class="fill-icon">
                            <use href="assets/svg/icon-sprite.svg#stroke-layout"></use>
                                </svg><span class="">Service</span></a>
                            <ul class="sidebar-submenu">
                                <li><a href="services">Voir les Services</a></li>
                                <li><a href="@service">Ajouter un Service</a></li>
                            </ul>
                        </li>
                    <?php endif ?>

                    <!-- nouvo 26/07/2024 -->
                    <?php if(@$is_tunnel=='1' || @$page_vente=='oui'): ?>
                        <li class="sidebar-list"><a class="sidebar-link" href="reservation">
                            <svg class="stroke-icon">
                        ...
                        <li class="sidebar-list"><a class="sidebar-link" href="paiement">
                            <svg class="stroke-icon">
                                <use href="assets/svg/icon-sprite.svg#stroke-animation"></use>
                            </svg>
                    ...
                    <!-- nouvo 26/07/2024 fin -->

                    <?php if (@$page_vente == 'oui') : ?>
                        ...
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                                ...
                                <svg class="fill-icon">
                            <use href="assets/svg/icon-sprite.svg#stroke-layout"></use>
                                </svg><span class="">Page d'offres <?php $id_core!=7 ?'de ventes':'' ?> </span></a>
                            <ul class="sidebar-submenu">
                                <li><a href="page-vente">Voir les pages</a></li>
                                <?php if ($id_core!=7):?>
                                    <li><a href="reservation">Reservations</a></li>
                                    <li><a href="@ajoute-page">Ajouter une page</a></li>
                                <?php endif ?>
                            </ul>
                        </li>
                    <?php endif ?>
                    ...
                    <?php if (@$supadmin == "oui") : ?>
                        <?php if (@$permission == 2): ?>
                            <li class="sidebar-list"><a class="sidebar-link" href="entreprises">
                                    <svg class="stroke-icon">
                                        <use href="assets/svg/icon-sprite.svg#stroke-bookmark"></use>
                                    </svg>
                                    <span class="entrepises">Les entreprises (<?= sizeof($entreprises) ?>) </span></a>
                        ...
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                            ...
                            </svg><span>Action Admin</span></a>
                            <ul class="sidebar-submenu">
                                <li><a href="voir-admin">Voir les Utilisateurs</a></li>
                                <li><a href="all_users">Utilisateurs</a></li>
                                <li><a href="@add-admin">Ajouter un utilisateurs </a></li>
                               <?php /* <li><a href="chart-apex.html">Apex Chart</a></li>
                    ...
                    <?php if($is_shop == 1 ): ?>
                        ...
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                            ...
                            <ul class="sidebar-submenu" style="display: none;">
                                <li><a href="datatable-commande">Commandes ( <?= sizeof($commandes)?> )</a></li>
                    ...
                    <?php endif ?>
                     ...
                     <li class="sidebar-list"><a class="sidebar-link" href="@menu-reglage">
                        <svg class="stroke-icon">
                            <use href="assets/svg/icon-sprite.svg#stroke-animation"></use>
                        </svg>
                    ...
                    <?php if (isset($permalien) and $onsite != 0) : ?>
                        ...
                        <li class="sidebar-list"><a class="sidebar-link" target="_blank" href="<?=$url ?>">
                            <svg class="stroke-icon">
                                <use href="assets/svg/icon-sprite.svg#stroke-maps"></use>
                            </svg>
                            <span class="entrepises"> Allez sur le site  </span></a>
                    
                        </li>
                    <?php endif ?>
                            
                    <?php if (@$dispo_artcle ==1 ) : ?>
                        <li class="sidebar-list"><a class="sidebar-link" target="_blank" href="https://akila.blog/<?= $permalien?>.e">
                            <svg class="stroke-icon">
                                <use href="assets/svg/icon-sprite.svg#stroke-maps"></use>
                            </svg>
                            <span class="entrepises"> Afficher mon espace </span></a>
