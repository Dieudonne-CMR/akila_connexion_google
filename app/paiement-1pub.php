...
$logo="https://1pub.net/assets/images/icons/1pub.png";
$entreprise="1pub Agency";
...
<head>
  ...
  <meta name="keywords" content="page de paiement, <?= $entreprise ?>, creation des page de ventes, creation des sites de blogs" />
  <meta name="author" content="<?= $entreprise ?>" />
  <meta name="robots" content="index, follow" />
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="description" content="<?= $entreprise ?> : Platefome de creation des sites de blog professionnels et des pages de ventes " />
  <meta property="og:title" content="<?= $entreprise ?> " />
  <meta property="og:description" content="<?= $entreprise ?> : page de paiement " />
  <!--<meta name="format-detection" content="telephone=no">-->
 <link rel="icon" href="<?= $logo ?>" type="image/x-icon">
  <title> Page de paiement <?= $entreprise ?>r</title>
  <base href="https://akila.blog/platform/paiement-1pub.php">
  <!-- Google font-->
        ...
        <div class="login-card login-dark">
          <div style="display: flex;">
            <div class="login-main" style="width: 200% !important">
              <div>
                <div><a class="logo text-start" href="javascript:void(0)"><img class="img-fluid for-light" src="<?= $logo ?>" alt="looginpage"><img class="img-fluid for-dark" src="<?=$logo?>" alt="looginpage"></a></div>
              </div>
